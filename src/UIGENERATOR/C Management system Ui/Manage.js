              ...
              <div className="main-container">
                <div className="header">
                  <div className="logo">Rent
                    <span className="logo-det">Cr</span></div>
                  <a className="header-link active" href="#"><svg viewBox="-6 0 512 512" fill="currentColor">
                  ...
                  <a className="header-link" href="#"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                      ...
                      <table className="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div className="status is-green"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                          ...
                          <tr>
                            ...
                            <td>€</td>
                            <td />
                            <td><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="feather feather-activity">
                          ...
                          <tr>
                            ...
                            <td>
                              <div className="status is-wait"><svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="feather feather-loader">
